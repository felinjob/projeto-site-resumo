...
export const cronogramaData: CronogramaItem[] = [
  ...
  { id: 4, legislacao: 'LC nº 09/2003', topico: 'Código de Projetos e Execuções de Obras e Edificações', resumoStatus: 'Disponível', questoesData: 'Disponível' },
  ...
  { id: 6, legislacao: 'Lei nº 5885/1987', topico: 'Proteção e preservação do patrimônio do Município', resumoStatus: 'Disponível', questoesData: 'Disponível' },
  { id: 7, legislacao: 'Decreto nº 19.226/2016', topico: 'Análise, Definição e Aprovação de Projetos de Parcelamento', resumoStatus: 'Disponível', questoesData: 'Disponível' }, // Data do resumo já passou
  { id: 8, legislacao: 'Lei Estadual nº 10.083/1998', topico: 'Código Sanitário do Estado de São Paulo', resumoStatus: 'Disponível', questoesData: 'Disponível' }, // Data do resumo já passou
